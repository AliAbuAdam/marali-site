...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1314: () => globalThis.removeSplashFromWeb(),
      _1315: Date.now,
      ...
      _1356: Object.is,
      _1360: (o, c) => o instanceof c,
      _1361: o => Object.keys(o),
      ...
      _1495: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1495(f,arguments.length,x0,x1) }),
      _1496: o => {
      ...
      _1522: (o, p) => p in o,
      _1523: (o, p) => o[p],
      _1540: (x0,x1) => x0.getElementById(x1),
      _1541: x0 => x0.remove(),
      _1542: (x0,x1) => x0.getElementsByClassName(x1),
      ...
      _3569: x0 => x0.navigator,
      _3833: x0 => x0.localStorage,
      _3958: x0 => x0.userAgent,
      _4166: x0 => x0.length,
      _6124: x0 => x0.length,
      _6185: () => globalThis.document,
      _6265: x0 => x0.body,
      _10730: (x0,x1) => { x0.background = x1 },
